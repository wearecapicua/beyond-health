        ...
        <div className="mx-auto lg:w-1/2 xl:w-[40%] flex flex-col justify-center lg:mx-0 lg:text-left">
          ...
          {info_title_one &&
            <div className="border border-solid border-white border-opacity-50 bg-white bg-opacity-10 rounded-[20px] items-center bg-accent-2 mb-3 md:my-1.5 py-6 px-10 flex gap-6">
              ...
              <div className="flex flex-col">
                <span className="text-white font-bold text-xl">{info_title_one}</span>
          ...
          {info_title_two &&
            <div className="border border-solid border-white border-opacity-50 bg-white bg-opacity-10 rounded-[20px] items-center bg-accent-2 my-3 md:my-2 py-6 px-10 flex gap-6">
              ...
              <div className="flex flex-col">
                <span className="text-white font-bold text-xl">{info_title_two}</span>
          ...
          {info_title_three &&
            <div className="border border-solid border-white border-opacity-50 bg-white bg-opacity-10 rounded-[20px] items-center bg-accent-2 my-3 md:my-2 py-6 px-10 flex gap-6">
              ...
              <div className="flex flex-col">
                <span className="text-white font-bold text-xl">{info_title_three}</span>
