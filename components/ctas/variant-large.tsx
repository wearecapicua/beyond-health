...
const LargeCta = ({ slice }: CtaSectionProps): JSX.Element => {
  ...
  return (
    <div id="variant-lg" className="mx-auto pb-10 lg:pb-20">
        ...
        <div className="cta-black-left-fade-sm lg:cta-black-left-fade overflow-hidden rounded-3xl lg:flex mx-5 sm:mx-0">
        
          <div className="cta-blue-circle-sm md:pb-10 pt-14 md:px-6 lg:py-0 mx-auto lg:max-w-md lg:pl-11 text-center flex flex-col justify-center items-center lg:items-start lg:cta-blue-black-fade lg:mx-0 lg:text-left">
