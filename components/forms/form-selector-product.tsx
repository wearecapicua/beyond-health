...
const FormSelectorProduct = ({ selected, label, value, description, price }: FormSelectorButtonProps) => {
		...
		<div
			...
			<div className="flex w-full cursor-pointer items-center justify-between gap-2">
				<label htmlFor={value}>
					...
					<p className="mt-2 text-2xl font-semibold text-main-blue sm:text-3xl">{description}</p>
