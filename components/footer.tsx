...
const Footer = () => {
	return (
		<footer className="bg-main-black" aria-labelledby="footer-heading">
			...
			<div className="mx-auto max-w-wide px-4 pb-8 pt-12 sm:pt-24 lg:py-20 xl:px-6">
				<div className="xl:grid xl:grid-cols-4 xl:gap-8">
					<div className="col-span-2 mt-10 max-w-[505px] xl:mt-0">
						...
						<p className="mb-12 mt-9 text-xs leading-6 text-white xl:mb-0">
